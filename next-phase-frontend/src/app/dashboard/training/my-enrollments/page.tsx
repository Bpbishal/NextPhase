            ...
            >
              <thead>
                <tr className="bg-gradient-to-r from-blue-200 via-purple-100 to-blue-100 text-blue-800">
                  <th className="py-3 px-3 text-left font-semibold rounded-tl-xl">Enrollment ID</th>
                  ...
                  <th className="py-3 px-3 text-left font-semibold">Seats Available</th>
                  <th className="py-3 px-3 text-left font-semibold">Start Date</th>
                  <th className="py-3 px-3 text-left font-semibold">End Date</th>
                  <th className="py-3 px-3 text-left font-semibold">Status</th>
                  <th className="py-3 px-3 text-left font-semibold rounded-tr-xl">Certificate Requested</th>
                </tr>
              </thead>
              <tbody>
                <AnimatePresence>
                  {enrollments.map((e, i) => (
                    ...
                    >
                      ...
                      <td className={`py-2 px-3 font-bold ${e.training.availableSeats === 0 ? 'text-red-500' : 'text-green-600'}`}>{e.training.availableSeats}</td>
                      <td className="py-2 px-3">{formatDate(e.training.startDate)}</td>
                      <td className="py-2 px-3">{formatDate(e.training.endDate)}</td>
